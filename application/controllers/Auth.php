...
class Auth extends CI_Controller
{
	...
	private function _sendEmail($token, $type)
	{
		...
		$config['smtp_user'] = 'aisyahraniww@gmail.com'; // isi dgn email
		$config['smtp_pass'] = 'tqkcgtdbzsdgzowy'; // password harus sesuai
		...
		$this->email->from('aisyahraniww@gmail.com', 'Dinda');
